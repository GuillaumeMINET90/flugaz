...
final class Version20220924185054 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE new_containers_movements (id INT AUTO_INCREMENT NOT NULL, new_container_id INT NOT NULL, technicien_id INT NOT NULL, quantity_rest DOUBLE PRECISION DEFAULT NULL, quantity_injected DOUBLE PRECISION NOT NULL, date DATE NOT NULL, cerfa_number VARCHAR(15) NOT NULL, customer VARCHAR(255) NOT NULL, remark LONGTEXT DEFAULT NULL, INDEX IDX_778B0335E26D01FD (new_container_id), INDEX IDX_778B033513457256 (technicien_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
